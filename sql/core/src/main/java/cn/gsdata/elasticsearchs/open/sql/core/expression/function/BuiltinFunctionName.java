...
public enum BuiltinFunctionName {
    ...
    /**
     * 定义of方法，基于字符串返回指定的BuiltinFunctionName
     *
     * @param str String
     * @return Optional<BuiltinFunctionName>
     */
